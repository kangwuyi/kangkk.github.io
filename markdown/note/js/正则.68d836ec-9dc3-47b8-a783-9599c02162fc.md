...
undefined
reg.exec("<!-- <input value=无忧脚本 type=text md-uuid=hkh-k15- > -->")
["<!-- <input value=无忧脚本 type=text md-uuid=hkh-k15- > -->", " <input value=无忧脚本 type=text", "hkh-k15-"]
reg.exec("<!-- <input value=无忧脚本 type=text id=md-uuid > -->pe=text id=md-uuid=hkh-k15- > -->")
var reg = /(\<\!\-\-)[\s+]*?<input(.*?)md-uuid=(.*)?\s+>[\s\S+]*?-->/g;
undefined
reg.exec("<!-- <input value=无忧脚本 type=text id=md-uuid > -->pe=text id=md-uuid=hkh-k15- > -->")
["<!-- <input value=无忧脚本 type=text id=md-uuid > -->pe=text id=md-uuid=hkh-k15- > -->", "<!--", " value=无忧脚本 type=text id=md-uuid > -->pe=text id=", "hkh-k15-"]
```

regStr = /<!--\s<input\smd-uuid=[a-zA-Z0-9\-]+.+?>\s-->/g;

var regResult = regStr.exec(fileFs);
